      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            var minSrc = 'http://r9nujcuji.hn-bkt.clouddn.com/min_photos/' + data.link[i];
            //var minSrc = 'https://raw.githubusercontent.com/zhengkkk369/Blog_Album/main/min_photos/' + data.link[i];

            var src = 'http://r9nujcuji.hn-bkt.clouddn.com/photos/' + data.link[i];
           // var src = 'https://raw.githubusercontent.com/zhengkkk369/Blog_Album/main/photos/' + data.link[i];
